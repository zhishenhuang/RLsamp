...
#         self.dones             = torch.zeros(capacity, dtype=torch.bool)
        ...
        self.position = 0
        self.mean_obs = torch.zeros(curr_obs_shape, dtype=torch.float32)
        self.std_obs  = torch.ones(curr_obs_shape, dtype=torch.float32)
        self._m2_obs  = torch.ones(curr_obs_shape, dtype=torch.float32)
        self.count_seen = 1
